...
const TimeTrackingPage = lazy(() => import('./pages/app/TimeTrackingPage').then(m => ({ default: m.TimeTrackingPage })))
...
export default function App() {
  return <><SessionGuard /><Suspense fallback={<PageLoader />}><Routes>
    ...
    <Route path="/app" element={<RequireAuth><AppLayout /></RequireAuth>}>
      <Route index element={<Navigate to="/app/dashboard" replace />} /><Route path="dashboard" element={<DashboardHomePage />} /><Route path="diagnostics" element={<DiagnosticsPage />} /><Route path="search" element={<SearchPage />} /><Route path="tasks" element={<TasksEntry />} /><Route path="my-tasks" element={<MyTasksPage />} /><Route path="projects" element={<ProjectsPage />} /><Route path="board" element={<BoardPage />} /><Route path="calendar" element={<CalendarPage />} /><Route path="time-tracking" element={<TimeTrackingPage />} /><Route path="knowledge-base" element={<KnowledgeBasePage />} /><Route path="knowledge-base/:id" element={<KnowledgeBasePage />} /><Route path="team" element={<Navigate to="/app/hr/employees" replace />} /><Route path="reports" element={<ReportsPage />} /><Route path="reports/:id" element={<ReportDetailPage />} /><Route path="audit" element={<AuditPage />} /><Route path="logs" element={<LogsPage />} /><Route path="profile" element={<ProfilePage />} /><Route path="analytics" element={<OrgAnalyticsEntry />} /><Route path="insights" element={<InsightsPage />} /><Route path="hr/employees" element={<EmployeesPage />} /><Route path="hr/employees/:id" element={<EmployeeProfilePage />} /><Route path="hr/time-off" element={<TimeOffPage />} /><Route path="crm/pipeline" element={<CrmPipelinePage />} /><Route path="crm/leads" element={<CrmLeadsPage />} /><Route path="settings" element={<SettingsPage />} /><Route path="notification-preferences" element={<NotificationPreferencesPage />} /><Route path="onboarding" element={<OnboardingPage />} /><Route path="billing" element={<BillingPage />} /><Route path="contractors" element={<ContractorsPage />} /><Route path="contractors/:id" element={<ContractorProfilePage />} /><Route path="jeczone" element={<JeczoneDashboardPage />} /><Route path="*" element={<Navigate to="/app/dashboard" replace />} />
